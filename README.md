...
a) Develop a comprehensive network topology incorporating all major infrastructure components necessary to support the following environment:
Main Campus:
...
b) Configure the core networking devices and selected end devices to ensure full end-to-end connectivity, including secure access to internal servers and the externally hosted email server.
...
Project Tasks
Task 1: Plan, design, and prototype the complete network topology for BeGreat University using Cisco Packet Tracer. This task focuses on architectural planning, logical segmentation, and infrastructure layout. Formative feedback will be provided in Week 6.
...
Students must submit the completed Packet Tracer file along with the written evaluation report. All configurations should be clearly structured and functional, demonstrating end-to-end connectivity and adherence to the specified requirements.
